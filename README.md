<!doctype html><html lang="pt-BR"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="description" content="ND BURGS — peça hambúrgueres, combos, porções, pastéis, açaís, milkshakes, sobremesas e bebidas pelo site."><meta name="nd-site-version" content="20260907-R29"><title>ND BURGS | Faça seu pedido</title><style>
...
:root{--nd-red:#e50914;--nd-red2:#ff3038;--nd-gold:#ffd21a;--nd-blue:#2585ff;--nd-blue2:#61b7ff;--nd-bg:#06070a;--nd-panel:#111318;--nd-line:rgba(255,255,255,.09);--nd-muted:#9da3ad}
*{box-sizing:border-box}
html{scroll-behavior:auto!important;overflow-x:hidden}
body{margin:0;background:radial-gradient(circle at 50% -10%,rgba(20,76,170,.12),transparent 34%),linear-gradient(180deg,#050608,#090b10 55%,#050608);color:#fff;overflow-x:hidden;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}
header{position:relative;z-index:1000;background:#050609;padding:10px 12px 16px;border-bottom:1px solid rgba(61,133,255,.35);box-shadow:0 10px 35px rgba(0,0,0,.55)}
header .logo{width:min(185px,68vw);max-width:68vw;display:block;margin:13px auto 0;filter:drop-shadow(0 10px 24px rgba(37,133,255,.16))}
.horarios{width:min(1080px,100%);margin:0 auto}
.horarios-box{display:grid;grid-template-columns:1fr 1fr;gap:10px;padding:10px;background:linear-gradient(145deg,#030405,#0c1017 52%,#020304);border:1px solid rgba(65,142,255,.55);border-radius:18px;box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 8px 25px rgba(0,0,0,.55),0 0 25px rgba(20,91,190,.14);position:relative;overflow:hidden}
.horarios-box:before{content:"";position:absolute;inset:0;background:linear-gradient(105deg,transparent 20%,rgba(90,169,255,.13) 45%,rgba(255,255,255,.05) 52%,transparent 72%);transform:translateX(-110%);animation:ndScheduleReflection 5.5s linear infinite;pointer-events:none}
.horario-card{position:relative;z-index:1;min-width:0;padding:12px 13px;border:1px solid rgba(96,160,255,.18);border-radius:13px;background:linear-gradient(145deg,rgba(255,255,255,.055),rgba(255,255,255,.015));box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 5px 16px rgba(0,0,0,.28)}
.horario-kicker{display:block;color:#9ecbff;font-size:9px;font-weight:1000;letter-spacing:1.4px;margin-bottom:4px}
.horario-card strong{display:block;color:#fff;font-size:18px;line-height:1.05;letter-spacing:-.4px}
.horario-linha{display:block;color:#c4cad4;font-size:10px;margin-top:6px;line-height:1.35}
.horario-card small{display:block;color:#7d8796;font-size:9px;margin-top:6px}
.status-aberto,.status-fechado{display:inline-flex!important;width:max-content;max-width:100%;margin-top:8px!important;padding:5px 9px;border-radius:999px;font-size:9px!important;font-weight:1000;white-space:normal!important}
.status-aberto{color:#bfffd1!important;background:rgba(37,211,102,.10);border:1px solid rgba(37,211,102,.25)}
.status-fechado{color:#ffb6bb!important;background:rgba(229,9,20,.10);border:1px solid rgba(229,9,20,.25)}
.entrega-card strong{font-size:24px;text-shadow:0 0 16px rgba(82,157,255,.25)}
.entrega-reflexo{display:block;color:#7eb6ff;font-size:9px;font-weight:1000;letter-spacing:1px;margin-top:8px}
@keyframes ndScheduleReflection{0%,55%{transform:translateX(-110%)}100%{transform:translateX(120%)}}
.container{width:100%;max-width:1180px;margin:auto;padding:14px 16px 30px}
.container>h1{font-size:clamp(30px,5vw,50px);line-height:.98;letter-spacing:-1.8px;text-align:center;color:#fff;margin:22px 0 10px}
.container>h1:after{content:"PEÇA PELO SITE • RÁPIDO, FÁCIL E DIRETO";display:block;color:#7d8490;font-size:10px;letter-spacing:2px;margin-top:8px;font-weight:900}
.modern-search{position:sticky;top:8px;z-index:800;display:flex;gap:8px;align-items:center;margin:12px 0 14px;padding:9px;border:1px solid var(--nd-line);background:rgba(10,12,16,.95);backdrop-filter:blur(15px);border-radius:14px;box-shadow:0 8px 28px rgba(0,0,0,.35)}
.modern-search input{margin:0!important;background:#07090c!important;border:1px solid rgba(255,255,255,.10)!important;border-radius:11px!important;padding:13px!important}
.categoria-menu{display:flex!important;overflow-x:auto;gap:8px;padding:2px 1px 9px;margin:0 0 12px;scrollbar-width:none;position:relative!important;top:auto!important;background:transparent!important}
.categoria-menu::-webkit-scrollbar{display:none}
.categoria-btn{flex:0 0 auto;background:#111318;border:1px solid #292d35;color:#ddd;border-radius:12px;padding:10px 13px;cursor:pointer;font-weight:900;min-height:42px}
.categoria-btn:hover{border-color:#3e86ff;color:#fff}
.categoria{margin-top:24px;scroll-margin-top:90px}
.categoria-titulo{display:flex;align-items:center;gap:9px;color:#fff;font-size:22px;font-weight:1000;border-bottom:1px solid var(--nd-line);padding-bottom:9px;margin-bottom:12px}
.categoria-titulo:before{content:"";width:5px;height:24px;border-radius:99px;background:linear-gradient(#ff3038,#e50914);box-shadow:0 0 14px rgba(229,9,20,.35)}
.produtos{display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:13px}
.produto{position:relative;background:linear-gradient(180deg,#17191e,#0d0f13);border:1px solid rgba(255,255,255,.075);border-radius:17px;padding:10px;box-shadow:0 10px 30px rgba(0,0,0,.28);overflow:hidden}
.produto:hover{border-color:rgba(229,9,20,.35)}
.produto-imagem{width:100%;height:200px;object-fit:contain;display:block;border-radius:13px;background:#090b0e;margin-bottom:9px}
.produto h3{font-size:16px;line-height:1.15;margin:9px 2px 5px;color:#fff}
.produto p{font-size:11px;line-height:1.4;color:#a3a8b1;min-height:34px;margin:0 2px}
.preco{font-size:20px;font-weight:1000;color:#ffd21a;margin:9px 2px}
.btn{width:100%;min-height:46px;border:0;border-radius:12px;padding:11px;cursor:pointer;font-weight:1000;font-size:13px}
.btn-add{background:linear-gradient(135deg,#e50914,#ff3038);color:#fff;box-shadow:0 8px 20px rgba(229,9,20,.18)}
.carrinho{background:linear-gradient(145deg,#15171c,#0d0f12);border:1px solid var(--nd-line);border-radius:20px;padding:18px;margin-top:24px;box-shadow:0 15px 45px rgba(0,0,0,.35)}
.item-carrinho{display:flex;justify-content:space-between;gap:10px;align-items:center;padding:12px 0;border-bottom:1px solid #282b31}
.controles{display:flex;align-items:center;gap:8px}.controles button,.controles-modal button{width:34px;height:34px;border:0;border-radius:8px;background:#e50914;color:#fff;font-weight:1000;cursor:pointer}.controles .remover,.controles-modal .remover{background:#8d1218!important}
.linha{display:flex;justify-content:space-between;padding:7px 0}.total{font-size:23px;font-weight:1000;color:#ffd21a;border-top:1px solid #444;margin-top:9px;padding-top:13px}
.vazio{text-align:center;color:#858b96;padding:24px}
.carrinho-flutuante{position:fixed!important;right:14px!important;top:14px!important;left:auto!important;bottom:auto!important;width:auto!important;padding:0!important;z-index:100000!important;background:transparent!important;border:0!important;box-shadow:none!important;opacity:0;pointer-events:none;transform:none!important}
.carrinho-flutuante.ativo{opacity:1;pointer-events:auto}
.carrinho-flutuante-info{display:flex;align-items:center;position:relative}.carrinho-flutuante-info strong{font-size:0;background:linear-gradient(180deg,#fff,#d8e6ff 48%,#6eaaff);color:#07101f;border:1px solid #a9c9ff;border-radius:11px;padding:10px 13px;box-shadow:inset 0 2px 0 rgba(255,255,255,.75),0 4px 0 #315b9d,0 9px 22px rgba(0,0,0,.55);cursor:pointer}.carrinho-flutuante-info strong:after{content:"VER CARRINHO";font-size:11px;font-weight:1000}.carrinho-flutuante-info span{position:absolute;right:-8px;top:-8px;min-width:23px;height:23px;display:grid;place-items:center;padding:0 5px;background:#e50914;border:2px solid #050608;border-radius:50%;font-size:9px;font-weight:1000}.carrinho-flutuante-direita{display:none!important}
.modal-carrinho,.modal-finalizar,.modal-personalizacao,.suggestions-modal{backdrop-filter:blur(9px)}
.painel-carrinho,.painel-finalizar,.modal-box{background:linear-gradient(160deg,#17191e,#090a0d)!important;border:1px solid rgba(229,9,20,.55)!important;border-radius:20px!important}
.btn-continuar-comprando{background:#1b1e24;color:#fff;margin-top:12px}.btn-finalizar-pedido,.btn-finalizar-modal{background:linear-gradient(135deg,#e50914,#ff3038);color:#fff;margin-top:12px}
input,select,textarea{font-family:inherit}
/* FAVORITOS — logo abaixo de ARTESANAIS */
.nd-favorites{margin:24px 0 8px;padding:16px;border:1px solid rgba(67,130,255,.28);border-radius:18px;background:linear-gradient(145deg,#0d1119,#08090d);box-shadow:0 12px 35px rgba(0,0,0,.32)}
.nd-fav-head{display:flex;align-items:flex-end;justify-content:space-between;gap:10px;margin-bottom:12px}.nd-fav-head span{font-size:9px;color:#7eb6ff;font-weight:1000;letter-spacing:1.5px}.nd-fav-head h2{margin:3px 0 0;color:#fff;font-size:21px;border:0;padding:0}.nd-fav-head small{color:#777f8b;font-size:9px;text-align:right}.nd-fav-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:9px}.nd-fav-item{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:11px;border:1px solid #252a33;border-radius:12px;background:#0b0e13}.nd-fav-item strong{font-size:12px;color:#fff}.nd-fav-item span{display:block;color:#ffd21a;font-size:11px;font-weight:900;margin-top:3px}.nd-fav-item button{border:0;border-radius:9px;padding:9px;background:#e50914;color:#fff;font-weight:1000;cursor:pointer}.nd-fav-empty{color:#777f8b;font-size:11px;line-height:1.5;padding:5px 0}
/* UPSELL NO CARRINHO */
#ndUpsell{margin-top:15px;padding:13px;border:1px solid rgba(58,128,255,.35);border-radius:16px;background:radial-gradient(circle at 90% 0,rgba(42,110,255,.13),transparent 35%),linear-gradient(145deg,#0d121b,#090b10)}
#ndUpsell .nd-upsell-head{display:flex;justify-content:space-between;gap:8px;align-items:end;margin-bottom:10px}.nd-upsell-head strong{font-size:16px}.nd-upsell-head span{font-size:9px;color:#7eaef9;text-align:right}.nd-upsell-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.nd-up-card{padding:9px;border:1px solid #252d3a;border-radius:12px;background:#0a0d12}.nd-up-card strong{display:block;font-size:11px;line-height:1.2;min-height:27px}.nd-up-price{display:block;color:#ffd21a;font-weight:1000;font-size:13px;margin:5px 0}.nd-up-qty{display:flex;align-items:center;justify-content:space-between;gap:5px;margin:6px 0}.nd-up-qty button{width:28px;height:28px;border:0;border-radius:7px;background:#202632;color:#fff;font-weight:1000;cursor:pointer}.nd-up-qty b{font-size:12px}.nd-up-add{width:100%;min-height:38px;border:0;border-radius:9px;background:linear-gradient(135deg,#2878ff,#6c5cff);color:#fff;font-size:10px;font-weight:1000;cursor:pointer}.nd-up-add.added{background:linear-gradient(135deg,#1fa85b,#25d366)}
/* evita rolagem horizontal acidental */
.modal-carrinho,.modal-finalizar,.modal-personalizacao,.suggestions-modal{overscroll-behavior:contain}
@media(max-width:700px){header{padding-bottom:13px}.horarios-box{grid-template-columns:1fr 1fr}.horario-card{padding:10px}.horario-card strong{font-size:15px}.entrega-card strong{font-size:21px}.container{padding:10px 9px 28px}.produtos{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.produto{padding:8px;border-radius:14px}.produto-imagem{height:auto;aspect-ratio:1/1}.produto h3{font-size:13px}.produto p{font-size:10px;min-height:38px}.preco{font-size:17px}.btn{font-size:11px;min-height:44px;padding:9px 5px}.nd-fav-grid{grid-template-columns:1fr}.nd-upsell-grid{grid-template-columns:1fr 1fr}.nd-up-card{min-width:0}.categoria-menu{padding-bottom:7px}.categoria-btn{font-size:10px;padding:9px 10px}.carrinho-flutuante{right:9px!important;top:9px!important}.carrinho-flutuante-info strong{padding:9px 11px}.carrinho-flutuante-info strong:after{font-size:10px}}
@media(max-width:390px){.horarios-box{gap:6px}.horario-card strong{font-size:13px}.horario-linha{font-size:9px}.entrega-reflexo{font-size:8px}.nd-upsell-grid{grid-template-columns:1fr}.produto h3{font-size:12px}}
@media(prefers-reduced-motion:reduce){.horarios-box:before{animation:none}.produto{transition:none!important}}
</style></head><body>
 ND R17: horário comercial real — terça a domingo, 18:00 às 00:30 
<header><div aria-label="Horário de atendimento e tempo de entrega" class="horarios">
<div class="horarios-box">
<div class="horario-card">
<span class="horario-kicker">HORÁRIO DE ATENDIMENTO</span>
<strong id="statusTitulo">PEDIDOS FECHADOS</strong>
<span class="horario-linha">TERÇA A DOMINGO • 18:00 ÀS 00:30</span>
<span class="status-fechado" id="statusHorario">🔴 FECHADO</span>
<small id="statusDetalhe">SEGUNDA-FEIRA • FECHADO</small>
</div>
<div class="horario-card entrega-card">
<span class="horario-kicker">TEMPO DE ENTREGA</span>
<strong>40–50 MIN</strong>
<span class="horario-linha">Após a confirmação do pedido</span>
<span class="entrega-reflexo">DELIVERY • RETIRADA</span>
</div>
</div>
</div>
...
</section><section aria-label="Meus favoritos" class="nd-favorites" id="ndFavorites">
<div class="nd-fav-head"><div><span>SEUS FAVORITOS</span><h2>❤️ MEUS FAVORITOS</h2></div><small>Salvos neste aparelho</small></div>
<div class="nd-fav-grid" id="ndFavoritesGrid"></div>
</section>
...
<div id="ndUpsell" style="display:none"></div><button class="btn btn-continuar-comprando" onclick="irParaCheckout()">
...
<div class="painel-finalizar" onclick="event.stopPropagation()"></div>
</div>
...
<style id="nd-r20-delivery-highlight-css">
...
(function(){
'use strict';
/* R29 — uma única camada de melhorias. Nenhuma função antiga de scroll automático é adicionada. */
try{ if(typeof carrinho!=='undefined' && Array.isArray(carrinho)) window.carrinho=carrinho; }catch(e){}

const $=s=>document.querySelector(s), $$=s=>Array.from(document.querySelectorAll(s));
const norm=v=>String(v||'').normalize('NFD').replace(/[\u0300-\u036f]/g,'').toUpperCase().replace(/\s+/g,' ').trim();
const money=v=>Number(v||0).toLocaleString('pt-BR',{style:'currency',currency:'BRL'});

/* HORÁRIO: terça a domingo, 18:00–00:30; segunda fechado. */
function updateHours(){
 const d=new Date(),day=d.getDay(),mins=d.getHours()*60+d.getMinutes();
 const open=day!==1 && (mins>=1080 || mins<=30);
 const title=$('#statusTitulo'),status=$('#statusHorario'),detail=$('#statusDetalhe');
 if(title)title.textContent=open?'PEDIDOS ABERTOS':'PEDIDOS FECHADOS';
 if(status){status.className=open?'status-aberto':'status-fechado';status.textContent=open?'🟢 ABERTO AGORA':'🔴 FECHADO AGORA';}
 if(detail)detail.textContent=day===1?'SEGUNDA-FEIRA • FECHADO':'TERÇA A DOMINGO • 18:00 ÀS 00:30';
}
updateHours(); setInterval(updateHours,30000);

/* FAVORITOS */
const FAV_KEY='ndburgs_favoritos_v3';
...
function productCard(name){return $$('.produto').find(c=>norm(c.querySelector('h3')?.textContent)===norm(name))}
function addProductFromCard(name){const c=productCard(name);if(!c)return false;const b=c.querySelector('.btn-add,.nd-fx-add');if(!b)return false;b.click();return true}
function renderFavorites(){
 const grid=$('#ndFavoritesGrid');if(!grid)return;const favs=getFavs();
 if(!favs.length){grid.innerHTML='<div class="nd-fav-empty">Nenhum favorito ainda. Toque no coração dos produtos para salvar seus preferidos.</div>';return}
 grid.innerHTML=favs.map((x,i)=>'<div class="nd-fav-item"><div><strong>'+escapeHtml(x.nome)+'</strong><span>'+money(x.preco)+'</span></div><button type="button" data-fav="'+i+'">COMPRAR</button></div>').join('');
 grid.querySelectorAll('[data-fav]').forEach(b=>b.onclick=()=>{const x=getFavs()[Number(b.dataset.fav)];if(x)addProductFromCard(x.nome)});
}
function escapeHtml(v){return String(v||'').replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]))}
function ensureFavoriteButtons(){
 $$('.produto').forEach(card=>{
  if(card.dataset.ndFavBound==='1')return;const h=card.querySelector('h3');if(!h)return;card.dataset.ndFavBound='1';
  const name=h.textContent.trim();let price=0;const pt=card.querySelector('.preco')?.textContent||'';const m=pt.match(/(\d+[\.,]\d{2})/);if(m)price=Number(m[1].replace('.','').replace(',','.'));
  const b=document.createElement('button');b.type='button';b.className='nd-heart';b.textContent=getFavs().some(x=>norm(x.nome)===norm(name))?'♥':'♡';b.setAttribute('aria-label','Favoritar '+name);
  b.style.cssText='position:absolute;right:9px;top:9px;z-index:20;width:34px;height:34px;border-radius:50%;border:1px solid rgba(255,255,255,.12);background:rgba(5,7,10,.88);color:#aaa;font-size:18px;cursor:pointer;display:grid;place-items:center;';
  if(b.textContent==='♥')b.style.color='#ff3b30';
  b.onclick=e=>{e.stopPropagation();let a=getFavs(),i=a.findIndex(x=>norm(x.nome)===norm(name));if(i>=0){a.splice(i,1);b.textContent='♡';b.style.color='#aaa'}else{a.push({nome:name,preco});b.textContent='♥';b.style.color='#ff3b30'}setFavs(a);renderFavorites()};
  card.appendChild(b);
 });
}

/* UPSELL INTELIGENTE — recomenda complementos e não repete o que já está no carrinho. */
const UPSELL={
 drinks:[['COCA COLA LATA',6],['COCA COLA ZERO LATA',6],['SPRITE LATA',6],['FANTA UVA LATA',6],['GUARANA LATA',6]],
 sauces:[['POTINHO CHEDDAR',3],['POTINHO BARBECUE',3],['POTINHO MAIONESE VERDE',3],['POTINHO MAIONESE ARTESANAL',3]],
 sweets:[['KITKAT',7],['SURPRESA DE UVA',12]],
 burgers:[['X-BACON',11.90],['X-SALADA',11.90],['X-EGG',11.90],['X-BURGUER',10.90]]
};
function cartItems(){try{return Array.isArray(window.carrinho)?window.carrinho:[]}catch(e){return[]}}
function cartNames(){return new Set(cartItems().map(x=>norm(x.nome)))}
function catalogPrice(name,fallback){const c=productCard(name);if(!c)return fallback;const m=(c.querySelector('.preco')?.textContent||'').match(/(\d+[\.,]\d{2})/);return m?Number(m[1].replace('.','').replace(',','.')):fallback}
function getUpsell(){
 const c=cartItems(),names=cartNames(),text=c.map(x=>norm(x.nome)).join(' '),out=[];
 const hasBurger=/X-BURGUER|X-SALADA|X-EGG|X-BACON|SELLIS|NUNES|GADEIA|PATAO|BERENICE|DINA|GAROTINHO|PEZAO|COMBO/.test(text);
 const hasSweet=/ACAI|MILKSHAKE|KITKAT|SURPRESA|PASTEL/.test(text);
 const hasDrink=/COCA|SPRITE|FANTA|GUARANA|DELL VALE|AGUA MINERAL/.test(text);
 const pools=hasBurger?[...UPSELL.drinks,...UPSELL.sauces,...UPSELL.sweets]:hasSweet?[...UPSELL.sweets,...UPSELL.drinks,...UPSELL.sauces]:hasDrink?[...UPSELL.burgers,...UPSELL.sweets,...UPSELL.sauces]:[...UPSELL.burgers,...UPSELL.drinks,...UPSELL.sweets];
 for(const [n,p] of pools){if(names.has(norm(n))||out.some(x=>norm(x.name)===norm(n)))continue;if(productCard(n))out.push({name:n,price:catalogPrice(n,p)});if(out.length>=4)break}
 return out;
}
function renderUpsell(){
 const box=$('#ndUpsell');if(!box)return;const items=getUpsell();
 if(!cartItems().length){box.style.display='none';return} if(!items.length){box.style.display='none';return}
 box.style.display='block';box.innerHTML='<div class="nd-upsell-head"><strong>💡 QUE TAL COMPLETAR SEU PEDIDO?</strong><span>Complementos que combinam com o que você escolheu</span></div><div class="nd-upsell-grid">'+items.map((x,i)=>'<div class="nd-up-card" data-up="'+i+'"><strong>'+escapeHtml(x.name)+'</strong><span class="nd-up-price">'+money(x.price)+'</span><div class="nd-up-qty"><button type="button" data-minus="'+i+'">−</button><b id="ndQty_'+i+'">1</b><button type="button" data-plus="'+i+'">+</button></div><button type="button" class="nd-up-add" data-add="'+i+'">ADICIONAR</button></div>').join('')+'</div>';
 items.forEach((x,i)=>{let q=1;const set=()=>{const e=$('#ndQty_'+i);if(e)e.textContent=q};box.querySelector('[data-minus="'+i+'"]')?.addEventListener('click',()=>{q=Math.max(1,q-1);set()});box.querySelector('[data-plus="'+i+'"]')?.addEventListener('click',()=>{q=Math.min(9,q+1);set()});box.querySelector('[data-add="'+i+'"]')?.addEventListener('click',()=>{for(let k=0;k<q;k++)window.adicionar(x.name,x.price);const b=box.querySelector('[data-add="'+i+'"]');if(b){b.textContent='✓ ADICIONADO';b.classList.add('added')}setTimeout(renderUpsell,350)});});
}
function ensureUpsell(){
 const modal=$('#modalCarrinho');if(!modal)return;const panel=modal.querySelector('.painel-carrinho');if(!panel)return;let box=$('#ndUpsell');if(!box){box=document.createElement('div');box.id='ndUpsell';const actions=panel.querySelector('.btn-continuar-comprando');if(actions)panel.insertBefore(box,actions);else panel.appendChild(box)}renderUpsell();
}
function patchCart(){
 if(typeof window.atualizarCarrinho!=='function'||window.atualizarCarrinho.__ndR29)return;
 const old=window.atualizarCarrinho;window.atualizarCarrinho=function(){
   try{if(typeof carrinho!=='undefined'&&Array.isArray(carrinho))window.carrinho=carrinho}catch(e){}
   const r=old.apply(this,arguments);renderUpsell();return r;
 };window.atualizarCarrinho.__ndR29=true;
}
/* Evita o antigo upsell aleatório: irParaCheckout agora fecha o carrinho e volta ao catálogo somente por ação do cliente. */
window.irParaCheckout=function(){
 const m=$('#modalCarrinho');if(m)m.classList.remove('ativo');document.body.style.overflow='';
 const first=$('.categoria[id]');if(first)first.scrollIntoView({behavior:'auto',block:'start'});
};
function init(){try{if(typeof carrinho!=='undefined'&&Array.isArray(carrinho))window.carrinho=carrinho}catch(e){}ensureFavoriteButtons();renderFavorites();patchCart();ensureUpsell();}
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',init,{once:true});else init();
setTimeout(init,600);setTimeout(init,1400);
})();
</script>
