...
(function(){
  ...
  function createUI(){
    ...
    if(!document.querySelector('.nd-v3-strip')){const x=document.createElement('div');x.className='nd-v3-strip';x.innerHTML='🔥 <b>ND BURGS</b> • Peça pelo site • Terça a sábado, das <b>18:00 às 00:30</b>';document.body.prepend(x)}<style>
.nd-v3-strip {
...
<div class="nd-promo-dia">

    <div class="nd-promo-titulo">
        🔥 PROMOÇÃO DO DIA 🔥
    </div>

    <div class="nd-promo-badge">
        HOJE!
    </div>

    <img
        class="nd-promo-imagem"
        src="https://i.ibb.co/Q7bDKy7g/Chat-GPT-Image-25-06-2026-23-21-08.png"
        alt="Surpresa de Uva"
    >

    <div class="nd-promo-conteudo">

        <div class="nd-promo-nome">
            SURPRESA DE UVA
        </div>

        <div>
            <span class="nd-promo-antigo">
                R$ 12,00
            </span>

            <span class="nd-promo-preco">
                R$ 7,99
            </span>
        </div>

        <div class="nd-promo-chamada">
