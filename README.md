...
(function(){
  ...
  function createUI(){
    ...
    if(!document.querySelector('.nd-v3-strip')){const x=document.createElement('div');x.className='nd-v3-strip';x.innerHTML='🔥 <b>ND BURGS</b> • PEÇA PELO SITE • TERÇA A SÁBADO DAS <b>18:00 ÁS 00:30</b>';document.body.prepend(x)}
